...
def get_data_x_y(verbose=False) :
    ...
    npzfile = np.load("../../scrambler_pytorch_coiled_coil_binders/" + dataset_name + "_" + experiment + "_pos_only.npz")
    
    x_1_train = npzfile['x_1_train']
    x_2_train = npzfile['x_2_train']
    l_1_train = npzfile['l_1_train']
    l_2_train = npzfile['l_2_train']
    ...
    y_train[digit_train == 0, 0] = 1
    y_train[digit_train == 1, 1] = 1
