...
from sal.datasets import coiled_coil_binder_dataset
...
dts = coiled_coil_binder_dataset
...
model_pytorch = GRUClassifier(batch_size=32, padding=30)
_ = model_pytorch.load_state_dict(torch.load("../../scrambler_pytorch_coiled_coil_binders/ppi_rnn_baker_big_set_5x_negatives_classifier_symmetric_drop_25_5x_negatives_balanced_partitioned_data_epoch_10_pytorch.pth"))
...
model_save_str = "pytorch_saliency_model_coiled_coil_binders_smaller_blur_resnet50_n_epochs_phase1_" + str(n_epochs_phase_1) + "_phase2_" + str(n_epochs_phase_2)
...
def phase2_visualise(s):
    ...
    mask = np.tile(pt['masks'][0][:, 0, :], (20, 1))
