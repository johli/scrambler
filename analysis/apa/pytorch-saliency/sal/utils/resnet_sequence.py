...
def conv3x3(in_planes, out_planes, stride=1, groups=1, dilation=1):
    ...
    return nn.Conv2d(in_planes, out_planes, kernel_size=(1, 3), stride=(1, stride),
                     padding=(0, dilation), groups=groups, bias=False, dilation=(1, dilation))
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, zero_init_residual=False,
        ...
        self.conv1 = nn.Conv2d(20, self.inplanes, kernel_size=(1, 3), stride=(1, 1), padding=(0, 1), bias=False)
        ## END
