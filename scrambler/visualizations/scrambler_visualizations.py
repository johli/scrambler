...
def plot_dna_importance_scores(importance_scores, ref_seq, figsize=(12, 2), score_clip=None, sequence_template='', fixed_sequence_template_scores=True, plot_start=0, plot_end=96, save_figs=False, fig_name=None) :
